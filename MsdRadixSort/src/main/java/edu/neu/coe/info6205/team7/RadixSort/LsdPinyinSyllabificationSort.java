...
/**
 * A class extends from PinyinSort to implement LSD Radix Sort for Chinese characters in Pinyin
 * Syllabification order
 *
 * @author Yiqing Jackie Huang
 */
public class LsdPinyinSyllabificationSort extends PinyinSort {
