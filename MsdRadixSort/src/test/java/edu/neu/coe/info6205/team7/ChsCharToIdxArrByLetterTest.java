...
public class ChsCharToIdxArrByLetterTest {
    ...
    public void testIdx1(){
        ...
        assertEquals(Arrays.asList(23, 3, 1, 5, 1, 0, 1),Arrays.stream(idx1).boxed().collect(Collectors.toList()));

        int[] idx2 = chsCharToIdxArrByLetter.CharAt('李');
        assertEquals(Arrays.asList(11, 4, 0, 0, 0, 0, 3),Arrays.stream(idx2).boxed().collect(Collectors.toList()));
    }
    ...
    public void testIdx2(){
        ...
        assertEquals(Arrays.asList(23, 3, 7, 0, 0, 0, 4),Arrays.stream(idx1).boxed().collect(Collectors.toList()));

        int[] idx2 = chsCharToIdxArrByLetter.CharAt('兴');
        assertEquals(Arrays.asList(21, 4, 5, 3, 0, 0, 1),Arrays.stream(idx2).boxed().collect(Collectors.toList()));
    }
    @Test
    ...
    public void testStringIdx1(){
        ...
        assertEquals(Arrays.asList(3,3,2,5,0,0,2,17,1,5,0,0,0,2),Arrays.stream(idx1).boxed().collect(Collectors.toList()));
        int[] idx2 = chsCharToIdxArrByLetter.CharAt("李白");
        assertEquals(Arrays.asList(11,4,0,0,0,0,3,2,1,4,0,0,0,2),Arrays.stream(idx2).boxed().collect(Collectors.toList()));
        int[] idx3 = chsCharToIdxArrByLetter.CharAt("杜甫");
        assertEquals(Arrays.asList(4,8,0,0,0,0,4,6,8,0,0,0,0,3),Arrays.stream(idx3).boxed().collect(Collectors.toList()));
    }
}
